...
class Users extends React.Component {
    ...
    render() {
        ...
        return ( < div > {
                this.state.loading || !userdata ? ( < div > loading... < /div>) : ( <
                    div >
                    <
                    h3 >
                    User information <
                    ...
                    <
                    p >
                    Username: { userdata[this.state.userid].username } < /p>  <
                    p >
                    ...
                    /p>  <
                    p >
                    CatchPhrase: { userdata[this.state.userid].company.catchPhrase } < /p> <
                    p >
                    Bs: { userdata[this.state.userid].company.bs } < /p>  <
                    /ul> <
                    /div>
                )
            } <
